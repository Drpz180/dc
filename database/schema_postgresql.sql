-- Schema PostgreSQL para Neon (migrado de MySQL)
-- Execute este arquivo no console SQL do Neon antes de usar o site
...
-- Atualiza updated_at automaticamente (equivalente ao ON UPDATE CURRENT_TIMESTAMP do MySQL)
